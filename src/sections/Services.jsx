...
export default function PerfectIT() {
  ...
  // Function when clicking "Learn More"
  const handleSelectService = (service) => {
    setSelectedService(service);
    window.scrollTo({ top: 0, behavior: "smooth" });
  };

  // FIX: Function when clicking "Back" -> Goes directly to Latest Services section
  const handleBackToServices = () => {
    setSelectedService(null);
    setTimeout(() => {
      const servicesSection = document.getElementById("latest-services");
      if (servicesSection) {
    ...
    <div style={{ backgroundColor: "#ffffff", fontFamily: "sans-serif", minHeight: "100vh" }}>
      <AnimatePresence mode="wait">
        {selectedService ? (
          ...
          >
            {/* BACK BUTTON: Calls handleBackToServices */}
            <button
          ...
          >
            ...
            {/* LATEST SERVICES SECTION TITLE WITH ID FOR SCROLLING */}
            <div id="latest-services" style={{ textAlign: "center", marginBottom: "50px", paddingTop: "20px" }}>
